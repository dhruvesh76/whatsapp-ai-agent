...
async def _send_completion_summary(wa_id: str, history: list[dict]):
    from whatsapp import send_message
    summary_prompt = (
        f"Read the conversation below. This enquiry is now complete.\n\n"
        f"STEP 1: Identify the enquiry category from the conversation: Piano / Violin / Fitness / Art / Academic (Preschool/Primary/Secondary/JC/Online) / University.\n\n"
        f"CRITICAL RULES:\n"
        ...
        f"STEP 2: Output using the matching format below. No extra text.\n\n"
        f"Always start with:\n"
        f"*Name:* [name]\n"
        f"*Phone:* +{wa_id}\n"
        f"*Postal Code:* [postal code]\n\n"
        f"Then use the category-specific section:\n\n"
        f"--- IF PIANO ---\n"
        f"*Student Gender:* [gender]\n"
        f"*Student Age:* [age]\n"
        f"*Has Piano at Home:* [Yes/No/Not provided]\n\n"
        f"*ABRSM Exam Grade:* [grade or Not provided]\n"
        f"*Purpose:* [Exam/Leisure/Not provided]\n"
        f"*Experience:* [Beginner/years of experience or Not provided]\n\n"
        f"*Male Tutor:* [Yes/No/Not mentioned]\n"
        f"*Remarks:* [exact words or Not provided]\n\n"
        f"--- IF VIOLIN ---\n"
        f"*Student Gender:* [gender]\n"
        f"*Student Age:* [age]\n"
        f"*Has Violin at Home:* [Yes/No/Not provided]\n\n"
        f"*ABRSM Exam Grade:* [grade or Not provided]\n\n"
        f"*Male Tutor:* [Yes/No/Not mentioned]\n"
        f"*Remarks:* [exact words or Not provided]\n\n"
        f"--- IF FITNESS ---\n"
        f"*Age:* [age]\n"
        f"*Fitness Objective:* [objective or Not provided]\n\n"
        f"*Current Situation:* [challenges or Not provided]\n"
        f"*Preferred Schedule:* [days/times or Not provided]\n\n"
        f"*Sessions Per Week:* [number or Not provided]\n"
        f"*Remarks:* [exact words or Not provided]\n\n"
        f"--- IF ART ---\n"
        f"*Student Gender:* [gender]\n"
        f"*Student Age:* [age]\n\n"
        f"*Male Tutor:* [Yes/No/Not mentioned]\n"
        f"*Remarks:* [exact words or Not provided]\n\n"
        f"--- IF ACADEMIC (Preschool/Primary/Secondary/JC/Online) ---\n"
        f"*Student Gender:* [gender]\n"
        f"*Level:* [level]\n"
        f"*Subject(s):* [subjects]\n\n"
        f"*School:* [school or Not provided]\n"
        f"*Stream:* [stream or Not provided]\n\n"
        f"*Male Tutor:* [Yes/No/Not mentioned]\n"
        f"*Remarks:* [exact words or Not provided]\n\n"
        f"--- IF UNIVERSITY ---\n"
        f"*Student Gender:* [gender]\n"
        f"*University/School:* [school or Not provided]\n\n"
        f"*Major/Course:* [major or Not provided]\n"
        f"*Module:* [module name or Not provided]\n\n"
        f"*Year:* [year or Not provided]\n"
        f"*Exam Date:* [date or Not provided]\n\n"
        f"*Assignment Due:* [date or Not provided]\n"
        f"*Male Tutor:* [Yes/No/Not mentioned]\n"
        f"*Remarks:* [exact words or Not provided]\n\n"
